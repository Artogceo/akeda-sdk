...
//     sandbox.akeda.ru поднят, однако команды этого CLI против него не
//     прогонялись, и делать вид, что проверены, нельзя: --base-url и
//     AKEDA_BASE_URL есть, адрес по умолчанию — боевой, и он назван вслух в
//     выводе каждой сетевой команды.
//
