...
817 операций — это много, и листать контракт руками не надо:
...
установки `ai_…` видят контракт по-разному: из 817 операций установке открыты
530, остальные обслуживают человека или ключ кабинета. Из стадии и права это не
...
живая таксономия, которой у вас нет.
