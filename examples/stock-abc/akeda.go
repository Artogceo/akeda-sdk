...
// вызываемых операций закрыт пятью чтениями плюс два обращения к
// собственному контуру установки. Держит это не обещание, а тест:
// TestCalledOperationsDoNotWrite читает вызовы из этого файла. Это первое живое расширение, и оно физически
